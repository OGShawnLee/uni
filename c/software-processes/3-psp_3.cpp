...
double get_circle_perimeter(const double &big) {
  return 2 * M_PI * big;
}
...
double get_rectangle_perimeter(const double &big, const double &medium) {
  return 2 * (big + medium);
}
...
double get_square_perimeter(const double &big) {
  return 4 * big;
}
...
double get_triangle_perimeter(const double &big, const double &medium, const double &small) {
      ...
      if (figure == Shape::INVALID or figure == Shape::UNSET) {
        ...
        switch (figure) {
          case Shape::CIRCLE:
            ...
            perimeter = get_circle_perimeter(big);
            break;
          case Shape::RECTANGLE:
            area = get_rectangle_area(big, medium);
            perimeter = get_rectangle_perimeter(big, medium);
            break;
          case Shape::SQUARE:
            area = get_square_area(big);
            perimeter = get_square_perimeter(big);
            break;
          ...
          case Shape::TRIANGLE_SCALENE:
            ...
            perimeter = get_triangle_perimeter(big, medium, small);
            break;
          default:
            break;
        }
        println("El área del " + get_shape_name(figure) + " es " + std::to_string(area) + " y su perímetro es " + std::to_string(perimeter));
      }
    }
  }
